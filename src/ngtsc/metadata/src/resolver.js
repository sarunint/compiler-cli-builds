...
class ResolvedReference extends Reference {
    constructor(node, primaryIdentifier) {
        super(node);
        this.primaryIdentifier = primaryIdentifier;
        this.identifiers = [];
        this.expressable = true;
    }
    toExpression(context, importMode = ImportMode.UseExistingImport) {
        const localIdentifier = pickIdentifier(context, this.primaryIdentifier, this.identifiers, importMode);
    ...
    addIdentifier(identifier) { this.identifiers.push(identifier); }
}
...
class AbsoluteReference extends Reference {
    constructor(node, primaryIdentifier, moduleName, symbolName) {
        super(node);
        this.primaryIdentifier = primaryIdentifier;
        this.moduleName = moduleName;
